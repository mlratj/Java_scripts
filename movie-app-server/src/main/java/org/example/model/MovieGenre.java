...
@Entity
@Table(name = "movie_genre", catalog = "mich", uniqueConstraints =
...
public class MovieGenre implements java.io.Serializable {
    ...
    public MovieGenre(Date modified, String abbr) {
        this.modified = modified;
        this.abbr = abbr;
    }
    public MovieGenre(Date created, Date modified, String name, String abbr, Integer
    ...
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "movieGenre")
